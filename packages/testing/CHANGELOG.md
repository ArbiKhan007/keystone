...
- [#6193](https://github.com/keystonejs/keystone/pull/6193) [`14cb7c5c4`](https://github.com/keystonejs/keystone/commit/14cb7c5c40456cd0d2c8408ed46823d2695614cc) Thanks [@timleslie](https://github.com/timleslie)! - Added an `app` value to the `TestArgs` type to provide direct access to the Express application from test runners.
...
- [#5926](https://github.com/keystonejs/keystone/pull/5926) [`3b9cdc2c0`](https://github.com/keystonejs/keystone/commit/3b9cdc2c0cc19be109d7d5e0d7ccd43946f35ffe) Thanks [@timleslie](https://github.com/timleslie)! - Initial release of the `@keystone-next/testing` package.
